    ...
    def __init__(self):
        ...
        workflow.add_conditional_edges(
            ...
            nodes.must_rewrite,
            {
                ...
                "stop": "skip_unrelated_email"  # Max retries - skip email and get next
            }
        )
        workflow.set_entry_point("load_inbox_emails")
        workflow.add_edge("load_inbox_emails", "check_new_emails")
        workflow.add_edge("send_email", "check_new_emails")
        workflow.add_edge("skip_unrelated_email", "check_new_emails")
